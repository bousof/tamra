 ...
 *
 *  Description: Class for computing and providing Hilbert iterator ordering tables.
...
struct HilbertTables {
  ...
  static const auto& get_orderings()                  { static const auto t = compute_orderings<CellType>(); return t; }
